...
public interface BoardRepository extends JpaRepository<Board,Long> {
    ...
    @Query("SELECT b FROM Board b WHERE b.boardTitle LIKE %:query% OR b.boardContent LIKE %:query%")
    Page<BoardDto> findByTitleContainingOrContentContaining(String query, Pageable pageable);
}
