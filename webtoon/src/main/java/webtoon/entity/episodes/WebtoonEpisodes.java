    ...
    public class WebtoonEpisodes {  // 회차
        ...
        @OneToMany(mappedBy = "webtoonEpisode", cascade = {CascadeType.REMOVE})
        ...
        @OneToMany(mappedBy = "webtoonEpisodes", cascade = {CascadeType.REMOVE})
        private List<PurchaseHistory> purchaseHistories = new ArrayList<>();

        @OneToMany(mappedBy = "episodes", cascade = {CascadeType.REMOVE})
